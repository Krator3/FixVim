...
-- Перемещение
vim.keymap.set("n", "<C-Л>", ":wincmd K<CR>") -- Переместить окно вверх
vim.keymap.set("n", "<C-О>", ":wincmd J<CR>") -- Переместить окно вниз
vim.keymap.set("n", "<C-Р>", ":wincmd H<CR>") -- Переместить окно влево
vim.keymap.set("n", "<C-Д>", ":wincmd L<CR>") -- Переместить окно вправо
