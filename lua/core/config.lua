...
vim.opt.undofile = true -- Возможность отменить изменения в файле после перезапуска NeoVim
vim.opt.shell = "/bin/bash" -- Командная оболочка для выполнения внешних команд в NeoVim
